...
- [uv](https://docs.astral.sh/uv/) - An extremely fast Python package and project manager. Install it with `curl -LsSf https://astral.sh/uv/install.sh | sh` or `pip install uv`.
